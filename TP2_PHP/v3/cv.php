...
<header class="bg-info text-white text-center py-4 position-relative">
    <h1>Mon CV</h1>
    <img src="image.png" alt="Hamid Haoua" class="position-absolute end-0 top-50 translate-middle-y" width="100"
        height="150">
</header>
...
<div class="container-fluid d-flex flex-grow-1">
    ...
    <div class="content p-4 bg-white shadow-sm rounded flex-grow-1">
        ...
        <ul>
            <li><strong>Stage Technique</strong> - Observatoire National de la Recherche Scientifique et Technologique
                (Mai - Septembre 2024)</li>
            <li><strong>Projet Ansible Playbook</strong> - Automatisation des logs réseau (Août 2022)</li>
        </ul>

        <h2 class="mt-4 mb-3">Formation</h2>
        <ul>
            <li><strong>Double Diplôme Ingénieur</strong> (2021-2025) - IMT Nord Europe et Académie Internationale
                Mohammed VI</li>
