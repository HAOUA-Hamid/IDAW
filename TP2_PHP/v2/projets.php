...
?>
        ...
        <div class="content p-4 bg-white shadow-sm rounded flex-grow-1">
            ...
            <ul>
                <li><strong>Automatisation des feux de circulation</strong> - Utilisation de capteurs LIDAR et de la modélisation YOLOv7.</li>
            ...
            <ul>
                <li><strong>Application Web Décentralisée</strong> - Développement d’une application sécurisée avec API.</li>
